...
#
set EVAL_OPTS="--refiner --muscle --mafft --clustalw2 --dialign --kalign --fsa"
...
foreach SIM ( DNATransTree-1-Tigger1-R3S-gput100  DNATransTree-1-Tigger1-R3S-gput1500  DNATransTree-1-Tigger1-R3S-gput3000 \
...
foreach SIM ( LINETree-1-L2-R3S-gput100  LINETree-1-L2-R3S-gput1500  LINETree-1-L2-R3S-gput3000 \
